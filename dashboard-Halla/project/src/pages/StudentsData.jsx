              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Arabe</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentStudents.map((student) => (
                    <tr key={student.StudentID}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">{student.Math}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{student.Science}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{student.Physics}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{student.Arabic}</td>
